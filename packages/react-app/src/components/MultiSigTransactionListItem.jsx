...
// const TransactionListItem = async function ({
//   item,
//   mainnetProvider,
//   blockExplorer,
//   price,
...
//   try {
//     data ?
//       txnData = readContracts[contractName].interface.parseTransaction({ data }) :
//       txnData = readContracts[contractName].interface.parseTransaction({ data: item.data })
